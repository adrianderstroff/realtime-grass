...
UPDATE:
As of Go 1.23.1 I simply installed the MinGW 64 binary from [winlibs](https://winlibs.com/). The version I used is *winlibs-x86_64-posix-seh-gcc-14.2.0-llvm-18.1.8-mingw-w64ucrt-12.0.0-r1*.
